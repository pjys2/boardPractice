package pjys.board.article.api;
...
public class ArticleApiTest {
    ...
    @Test
    void readTest(){
        ArticleResponse response = read(193351231713599488L);
        System.out.println("response = " + response);
    }
    ...
    void readAllInfiniteScrollTest(){
        ...
        Long lastArtcleId = articles1.getLast().getArticleId();

        List<ArticleResponse> articles2 = restClient.get()
                .uri("/v1/articles/infinite-scroll?boardId=1&pageSize=5&lastArticleId=%s".formatted(lastArtcleId))
                .retrieve()
                .body(new ParameterizedTypeReference<List<ArticleResponse>>() {
                });
